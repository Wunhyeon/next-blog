...
export default function BlogForm({
  ...
  return (
    <Form {...form}>
      ...
      >
        <div
          className="p-5 flex items-center flex-wrap gap-5 justify-between
        border-b 
        "
        >
          <div className="flex gap-5 items-center flex-wrap">
            <span
              role="button"
              tabIndex={0}
              className="flex items-center gap-1 border bg-zinc-700
            p-2 rounded-md hover:ring-2 hover:ring-zinc-400
            transition-all
            "
              onClick={() =>
                setIsPreview(
